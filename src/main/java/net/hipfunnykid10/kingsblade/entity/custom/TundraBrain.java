...
public class TundraBrain {
    ...
    public static final int EMERGE_DURATION = MathHelper.ceil(5f);
    ...
    protected static Brain<?> create(FirstOfTheTundraEntity warden, Dynamic<?> dynamic) {
